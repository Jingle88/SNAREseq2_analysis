...
R1fadir = '/hwmaster/hujingling/SNAREseq2/fastq_raw/MEIJI_seq/20260518/AC_contami/AC_contami_R1_raw.fastq.gz'
R2fqdir = '/hwmaster/hujingling/SNAREseq2/fastq_raw/MEIJI_seq/20260518/AC_contami/AC_contami_R2_raw.fastq.gz'
...
with open('output_ATACseq_bo_R2.fastq', 'w', buffering=1024 * 1024) as out_r2, \
     open('output_ATACseq_bo_R1.fastq', 'w', buffering=1024 * 1024) as out_r1:
    ...
    for (r1_name, r1_seq, r1_qual), (r2_name, r2_seq, r2_qual) in tqdm(
        ...
        # fq[pos_index[i]].seq[94:151]
        out_r2.write(f"@{r2_name + ' CB:Z:' + bc + ' UB:Z:' + umi}\n")
        out_r2.write(f"{r2_seq[94:151]}\n")
        out_r2.write("+\n")
        out_r2.write(f"{r2_qual[94:151]}\n")
